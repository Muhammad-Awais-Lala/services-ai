    ...
    <ScrollView className="flex-1 bg-neutral-950" contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View className="flex-1 justify-center px-6 relative z-10">
        ...
        <View className="bg-black/40 rounded-2xl p-6 border border-white/10">
          <View className="mb-4">
            <Text className="text-neutral-300 text-sm font-medium mb-2">New Password</Text>
            <TextInput
          ...
          <View className="mb-5">
            <Text className="text-neutral-300 text-sm font-medium mb-2">Confirm Password</Text>
            <TextInput
              className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white"
              placeholder="••••••••"
              placeholderTextColor="#737373"
          ...
          >
            {loading ? (
              ...
              <Text className="text-white text-sm font-semibold">Reset Password</Text>
            )}
          </TouchableOpacity>
        </View>
      </View>
